...
- GitHub Açıklaması ve Anahtar Kelimeler
...
```bash
git clone <repo-url>
cd sifir-gorsel-restorant-cafe-menusu
```
...
Yeni sunucuya bu iki yapıyı kopyaladığınızda menü verileri korunur.
...
### Kısa açıklama (kopyala-yapıştır)
...
- bar menü yazılımı
- qr menü php
- sqlite restoran menü
- mysqlsiz menü paneli
- dijital menü scripti
- restoran indirim sistemi
- mobil uyumlu menü
